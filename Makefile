...
GCC_BIN = 
PROJECT = demo
OBJECTS = ./logging_code.o ./SDFileSystem/SDFileSystem.o ./SDFileSystem/SDCRC.o ./SDFileSystem/FATFileSystem/FATFileSystem.o ./SDFileSystem/FATFileSystem/FATFileHandle.o ./SDFileSystem/FATFileSystem/FATDirHandle.o ./SDFileSystem/FATFileSystem/ChaN/diskio.o ./SDFileSystem/FATFileSystem/ChaN/ccsbcs.o ./SDFileSystem/FATFileSystem/ChaN/ff.o ./TinyGPS/TinyGPS.o ./Pressure/MS5803.o ./Temperature/TMP102.o ./PID/PID.o ./Watchdog/Watchdog.o ./RingBuffer/RingBuffer.o ./TaskManager/TaskManager.o ./ScheduleEvent/ScheduleEvent.o  
...
INCLUDE_PATHS = -I. -I./TaskManager -I./ScheduleEvent -I./RingBuffer -I./TaskContext -I./PID -I./Watchdog -I./Pressure -I./Temperature -I./SDFileSystem -I./TinyGPS -I./mbed -I./SDFileSystem/FATFileSystem -I./SDFileSystem/FATFileSystem/ChaN -I./mbed/TARGET_NUCLEO_L152RE -I./mbed/TARGET_NUCLEO_L152RE/TARGET_STM -I./mbed/TARGET_NUCLEO_L152RE/TARGET_STM/TARGET_STM32L1 -I./mbed/TARGET_NUCLEO_L152RE/TARGET_STM/TARGET_STM32L1/TARGET_NUCLEO_L152RE -I./mbed/TARGET_NUCLEO_L152RE/TOOLCHAIN_GCC_ARM 
