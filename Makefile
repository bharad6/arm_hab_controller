...
INCLUDE_PATHS = -I. -I./SDFileSystem -I./SDFileSystem/FATFileSystem -I./SDFileSystem/FATFileSystem/ChaN -I./TinyGPS -I./mbed -I./mbed/TARGET_NUCLEO_L152RE -I./mbed/TARGET_NUCLEO_L152RE/TARGET_STM -I./mbed/TARGET_NUCLEO_L152RE/TARGET_STM/TARGET_STM32L1 -I./mbed/TARGET_NUCLEO_L152RE/TARGET_STM/TARGET_STM32L1/TARGET_NUCLEO_L152RE -I./mbed/TARGET_NUCLEO_L152RE/TOOLCHAIN_GCC_ARM 
